...
## Aegraph v0 Design Decisions

The first iteration of Aegraph will be purely web-based and written in typescript.
...
* Aegraph is a big idea, and the priority is building an MVP around which the idea will be concretizied.
...
If Aegraph is properly designed and well-understood, it can be rewritten in WASM for near-native performance.

Further down the road, Aegraph will offer robust rule-based and purpose-based access control systems to offer unprecedented composability of graph-based information that can be shared across organizational contexts.
