...
import "./AegraphIframe.css";

interface AegraphIframeProps {
...
/**
 * AegraphIframe - A React component for embedding HTML elements into markdown files
 *
 ...
 */
const AegraphIframe: React.FC<AegraphIframeProps> = ({
  src,
  title,
  width = "100%",
  height = "400px",
  ...
  return (
    <div
      ref={containerRef}
      className={`aegraph-iframe-container ${className}`}
