...
import AegraphIframe from "../AegraphIframe";
...
describe("AegraphIframe", () => {
  ...
  it("renders with default props", () => {
    render(<AegraphIframe {...defaultProps} />);
  ...
  it("renders with custom width and height", () => {
    render(<AegraphIframe {...defaultProps} width={800} height={600} />);

    const container = screen
      .getByTitle("Test Iframe")
      .closest(".aegraph-iframe-container");
  ...
  it("hides loading state when showLoading is false", () => {
    render(<AegraphIframe {...defaultProps} showLoading={false} />);
  ...
  it("hides controls when showControls is false", () => {
    render(<AegraphIframe {...defaultProps} showControls={false} />);
  ...
  it("calls onLoad when iframe loads", async () => {
    ...
    render(<AegraphIframe {...defaultProps} onLoad={onLoad} />);
  ...
  it("calls onError when iframe fails to load", async () => {
    ...
    render(<AegraphIframe {...defaultProps} onError={onError} />);
  ...
  it("applies custom className", () => {
    render(<AegraphIframe {...defaultProps} className="custom-class" />);
  ...
  it("applies custom styles", () => {
    ...
    render(<AegraphIframe {...defaultProps} style={customStyle} />);
