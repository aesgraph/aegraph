...
const createGraph = (): Graph => {
  ...
  const n_root = g.createNode({
    id: "aegraph_components",
    type: "aegraph_components",
    label: "Aegraph Components",
    userData: {
      description: "Key architectural and conceptual components of Aegraph.",
    },
  });
  ...
  const n_ecs = g.createNode({
    ...
    userData: {
      description:
        "Aegraph employs an ECS architecture to manage and render semantic data in a flexible and modular way.",
    },
  });
  ...
  const n_copilot_prosthetic = g.createNode({
    ...
    userData: {
      description:
        "Makes Aegraph not only a tool for experts but also a cognitive prosthetic for students, researchers, and technologists.",
    },
  });
  ...
  const n_ecosystem = g.createNode({
    id: "aegraph_ecosystem",
    type: "architecture",
    label: "Web-based Graph-based Application Ecosystem",
    userData: {
      description:
        "Aegraph is the foundation of a web-based application ecosystem grounded in graph-based semantics.",
    },
  });
  ...
  const n_ecosystem_interop = g.createNode({
    ...
    userData: {
      description:
        "Any tool built on Aegraph is fundamentally interoperable with others via shared graph semantics.",
    },
  });
  ...
  const n_ecosystem_react = g.createNode({
    ...
    userData: {
      description:
        'Positions Aegraph as the "React for Knowledge"—a modular framework for building and sharing smart, human-centric interfaces for graph-structured data.',
    },
  });
...
export const demo_scenegraph_aegraph_components = () => {
  return new SceneGraph({
    graph: createGraph(),
    metadata: {
      name: "Aegraph Components",
      description:
        "A graph of the key architectural and conceptual components of Aegraph.",
    },
    defaultAppConfig: {
      activeView: "ReactFlow",
      activeLayout: GraphvizLayoutType.Graphviz_dot,
      activeSceneGraph: "Aegraph Components",
      windows: {
