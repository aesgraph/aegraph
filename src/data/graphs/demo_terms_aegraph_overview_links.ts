...
import { demo_scenegraph_aegraph_overview } from "./demo_aegraph_overview";
import { demo_scenegraph_writing_terms } from "./demo_writing_terms";

export const demo_scenegraph_terms_aegraph_overview_links = () => {
  // Merge both graphs
  const tmp = new SceneGraph();
  mergeIntoSceneGraph(tmp, demo_scenegraph_aegraph_overview());
  ...
  // Aegraph Overview <-> Terms
  g.createEdgeIfMissing(
    overviewId("Aegraph Overview"),
  ...
  return new SceneGraph({
    graph: g,
    metadata: {
      name: "Terms-AegraphOverview Links",
      description:
        "A graph linking Aegraph Overview nodes to writing terms by semantic and conceptual relationship.",
    },
    defaultAppConfig: {
      activeView: "ReactFlow",
      activeLayout: GraphvizLayoutType.Graphviz_dot,
      activeSceneGraph: "Terms-AegraphOverview Links",
      windows: {
