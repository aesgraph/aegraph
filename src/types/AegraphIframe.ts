...
/**
 * Props interface for the AegraphIframe component
 */
export interface AegraphIframeProps {
 ...
 */
export interface AegraphIframeEventHandlers {
 ...
 */
export interface AegraphIframeTheme {
