...
Aegraph has a highly configurable layout system with many tools for users and developers to create their own applets.
...
The layout system highlights a core feature of Aegraph, which is being able to configure an arrangement of views on top of a unified data model to gain new insights and do interoperable work. Aegraph can effectively function as a dashboarding tool, but it also provides a wide range of capabilities outside of that scope.
