...
Aegraph provides a comprehensive set of layout algorithms for organizing graph nodes in both 2D and 3D space. The layout engine supports multiple layout libraries and custom algorithms, making it easy to find the right visualization for your data.
...
Custom algorithms designed specifically for Aegraph:
